...
RSpec.describe 'Admin Applications Show Page', type: :feature do
  ...
  let(:pet3_application) { PetApplication.create!(application_id: applicant2.id, pet_id: pet_4.id) }
  let!(:pet4_application) { PetApplication.create!(application_id: applicant2.id, pet_id: pet_5.id) }
  let!(:pet5_application) { PetApplication.create!(application_id: @applicant3.id, pet_id: @pet_6.id) }
